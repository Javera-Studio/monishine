  ...
  return (
    <SiteLayout>
      ...
      <div className="container-editorial max-w-3xl py-16 md:py-24">
        <div className="relative aspect-[16/7] overflow-hidden shadow-soft mb-14">
          <Image src={article.image} alt={article.title} fill className="object-cover" sizes="(min-width: 768px) 768px, 100vw" />
        </div>
